...
nvcc -c MathLinear.cu -o MathLinear.o -g -O0 -arch=sm_12
if [ $? ]; then echo "     OK"; else echo "     ERROR"; fi
echo ""

echo "     MAINUI.C + OBJ.O + CAMERA.O + MATHCAMERA.O + MATHLINEAR.O -> SPACE.OUT"
nvcc MainUI.c Camera.o MathCamera.o MathLinear.o Obj.o -o Space.out -I /usr/include/GL/ -L /usr/lib/x86_64-linux-gnu/ -lGL -lGLU -lglut -g -O0 -arch=sm_12
if [ $? ]; then echo "     OK"; else echo "     ERROR"; fi
echo ""
